...
class Autos extends CI_Controller {
    ...
    public function index()
    {
        ...
        echo alink('backend/autos/registrar');
        echo alink('backend/autos/seleccionar_confort');
        echo alink('backend/autos/seleccionar_seguridad');
        echo alink('backend/autos/seleccionar_multimedia');
        echo alink('backend/autos/seleccionar_exterior');
        echo alink('backend/autos/subir_imagen');
        echo alink('backend/autos/all');
        echo alink('backend/autos/show');
